...
public class SQSNotificationDto {
    ...
    public static SQSNotificationDto of(Long whoToNotifty, RawNotificationData rawNotificationData) {
        return new SQSNotificationDto(
                Collections.singletonList(whoToNotifty),
                rawNotificationData
        );
    }

    public static SQSNotificationDto of(List<Long> whoToNotifty, RawNotificationData rawNotificationData) {
        return new SQSNotificationDto(
                whoToNotifty,
                rawNotificationData
        );
