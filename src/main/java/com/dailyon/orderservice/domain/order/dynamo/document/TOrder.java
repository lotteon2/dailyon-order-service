package com.dailyon.orderservice.domain.order.dynamo.document;
...
import static com.dailyon.orderservice.domain.order.dynamo.document.TOrder.DYNAMO_TABLE_NAME;
